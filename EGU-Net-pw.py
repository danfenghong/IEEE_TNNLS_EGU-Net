...
def mynetwork(x_pure, x_mixed, parameters, isTraining, keep_prob, momentum = 0.9):
    ...
    with tf.name_scope("x_layer_3"):
         ...
         x_pure_z3_bn = tf.layers.batch_normalization(x_pure_z3, axis = 1,  momentum = momentum, training = isTraining, name = 'l3')
...
def train_mynetwork(x_pure_set, x_mixed_set, y_train, y_test, learning_rate_base = 0.1, beta_reg = 0.005, num_epochs = 200, minibatch_size = 8000, print_cost = True):
